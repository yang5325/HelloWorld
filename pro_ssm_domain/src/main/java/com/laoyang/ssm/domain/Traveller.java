...
public class Traveller {
    ...
    private String credentialsTypeStr;  //证件类型字符串形式
    ...
    public void setCredentialsType(Integer credentialsType) {
        ...
        this.credentialsTypeStr = credentialsType == 0 ? "身份证": credentialsType ==1 ? "护照": "军官证";
    }
    ...
    public void setTravellerType(Integer travellerType) {
        ...
        this.travellerTypeStr = travellerType == 0 ? "成人" : "儿童";
    }
